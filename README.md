...
This action treats information from files generated by different Maven plugins and dependencies. It ouputs variables of type String to visualize the information under the Markdown format.
...
The Markdown formatted String the used with an action that will comment the pull request.
